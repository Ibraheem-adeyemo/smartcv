...
const thisHour = `${today.getHours() + 1}`.length === 1 ? `0${today.getHours() + 1}` : `${today.getHours() + 1}`
const thisMinutes = `${today.getMinutes() + 1}`.length === 1 ? `0${today.getMinutes() + 1}` : `${today.getMinutes() + 1}`
